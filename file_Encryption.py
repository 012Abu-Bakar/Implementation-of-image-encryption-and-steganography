...
def encrypt_file(pass_word):
    ...
    if secret_key == "":
        ...
        messagebox.showerror("Encryption", "Encrypted")
        status_label.pack()
...
def decrypt_file(pass_word):
    ...
    if secret_key == "":
        ...
        messagebox.showerror("Decryption", "Decrypted")
        status_label.pack()
...
root.geometry("1465x740")
root.config(background="black")

#icon

img_icon = PhotoImage(file="key3.png")

#to change the icon of title bar img should be obj. of PhotoImage class
root.iconphoto(True,img_icon)  #iconphoto-> to set the icon
